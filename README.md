...
- **Mob Actor Type, Monster Statblocks & Compendium**:
  ...
  - **Direct Combat Attacks & Tactical Spells**: All mob offensive actions, spells (*Fireball*, *Firebolt*, *Mini Fireball*, *Firestrike*, *Clap Cloud*, *Magic Missile*, *Scream*, *Gloat*, *Lightning Bolt*), and special actions are configured as `attack` items rolling directly from Page 1 with no untrained disadvantage.
