...
export const DCC_MOBS = [
  // 1. Aranaea Magnus (Neighborhood Boss, Large 5, Monstrous)
  {
    ...
    system: {
      abilities: {
        ...
        int: { value: 5, unenhanced: 5, mod: 2 },
        con: { value: 10, unenhanced: 10, mod: 4 },
        dex: { value: 11, unenhanced: 11, mod: 4 },
        cha: { value: 8, unenhanced: 8, mod: 3 }
      },
      attributes: {
        hp: { value: 40, max: 40, temp: 0, pct: 100, bars: 10, hpPerBar: 4 },
        mana: { value: 0, max: 0, pct: 100 },
        evade: { items: 0, buffs: 0, total: 4 },
        dr: { armor: 1, items: 0, buffs: 0, total: 1 },
        speed: { move: 30, step: 10 },
        aiFavor: 0,
        size: "Large",
        debuffs: "",
  ...
  // 2. Chef BoyardOoze (Mob, Small 2, Ooze)
  {
    ...
    system: {
      abilities: {
        ...
        int: { value: 1, unenhanced: 1, mod: 1 },
        con: { value: 6, unenhanced: 6, mod: 3 },
        dex: { value: 3, unenhanced: 3, mod: 2 },
        cha: { value: 1, unenhanced: 1, mod: 1 }
      },
      attributes: {
        hp: { value: 12, max: 12, temp: 0, pct: 100, bars: 4, hpPerBar: 3 },
        mana: { value: 0, max: 0, pct: 100 },
        evade: { items: 0, buffs: 0, total: 2 },
        dr: { armor: 2, items: 0, buffs: 0, total: 2 },
        speed: { move: 10, step: 5 },
        aiFavor: 0,
        size: "Small",
        debuffs: "",
        externalBuffs: { buff1: "", buff2: "", buff3: "" },
  ...
  // 3. Rat Brute (Mob, Petite 3, Humanoid)
  {
  ...
  // 4. Rat Shaman (Mob, Petite 3, Humanoid)
  {
    ...
    system: {
      abilities: {
        str: { value: 1, unenhanced: 1, mod: 1 },
        int: { value: 10, unenhanced: 10, mod: 4 },
        con: { value: 3, unenhanced: 3, mod: 2 },
        dex: { value: 3, unenhanced: 3, mod: 2 },
        cha: { value: 3, unenhanced: 3, mod: 2 }
      },
      attributes: {
        hp: { value: 10, max: 10, temp: 0, pct: 100, bars: 5, hpPerBar: 2 },
  ...
  // 5. Rat Hooligan (Mob, Petite 3, Rat Hybrid)
  {
    ...
    system: {
      abilities: {
        str: { value: 8, unenhanced: 8, mod: 3 },
        int: { value: 11, unenhanced: 11, mod: 4 },
        con: { value: 3, unenhanced: 3, mod: 2 },
        dex: { value: 3, unenhanced: 3, mod: 2 },
        cha: { value: 4, unenhanced: 4, mod: 2 }
      },
      attributes: {
        hp: { value: 16, max: 16, temp: 0, pct: 100, bars: 8, hpPerBar: 2 },
        mana: { value: 11, max: 11, pct: 100 },
        evade: { items: 0, buffs: 0, total: 2 },
        dr: { armor: 2, items: 0, buffs: 0, total: 2 },
        speed: { move: 20, step: 10 },
        aiFavor: 0,
  ...
  // 6. Critical Consensus (Neighborhood Boss, Huge 6, Zombie)
  {
    ...
    system: {
      abilities: {
        ...
        int: { value: 5, unenhanced: 5, mod: 2 },
        con: { value: 20, unenhanced: 20, mod: 5 },
        dex: { value: 5, unenhanced: 5, mod: 2 },
        cha: { value: 4, unenhanced: 4, mod: 2 }
      },
      attributes: {
        hp: { value: 55, max: 55, temp: 0, pct: 100, bars: 11, hpPerBar: 5 },
        mana: { value: 0, max: 0, pct: 100 },
        evade: { items: 0, buffs: 0, total: 2 },
        dr: { armor: 2, items: 0, buffs: 0, total: 2 },
        speed: { move: 10, step: 5 },
  ...
  // 7. Canis Knights (Mob, Petite 3, Humanoid)
  {
    ...
    system: {
      abilities: {
        str: { value: 6, unenhanced: 6, mod: 3 },
        int: { value: 1, unenhanced: 1, mod: 1 },
        con: { value: 4, unenhanced: 4, mod: 2 },
        dex: { value: 3, unenhanced: 3, mod: 2 },
        cha: { value: 6, unenhanced: 6, mod: 3 }
      },
      attributes: {
        hp: { value: 10, max: 10, temp: 0, pct: 100, bars: 5, hpPerBar: 2 },
        mana: { value: 0, max: 0, pct: 100 },
  ...
  // 8. Grimes (Mob, Petite 3, Ooze)
  {
    ...
    system: {
      abilities: {
        ...
        int: { value: 1, unenhanced: 1, mod: 1 },
        con: { value: 10, unenhanced: 10, mod: 4 },
        dex: { value: 2, unenhanced: 2, mod: 1 },
        cha: { value: 1, unenhanced: 1, mod: 1 }
      },
      attributes: {
        hp: { value: 20, max: 20, temp: 0, pct: 100, bars: 5, hpPerBar: 4 },
        mana: { value: 0, max: 0, pct: 100 },
        evade: { items: 0, buffs: 0, total: 1 },
        dr: { armor: 2, items: 0, buffs: 0, total: 2 },
        speed: { move: 15, step: 5 },
        aiFavor: 0,
        size: "Petite",
        debuffs: "",
        externalBuffs: { buff1: "", buff2: "", buff3: "" },
  ...
  // 9. Trollogs (Mob, Large 5, Humanoid)
  {
    ...
    system: {
      abilities: {
        str: { value: 6, unenhanced: 6, mod: 3 },
        int: { value: 3, unenhanced: 3, mod: 2 },
        con: { value: 4, unenhanced: 4, mod: 2 },
        dex: { value: 6, unenhanced: 6, mod: 3 },
        cha: { value: 1, unenhanced: 1, mod: 1 }
      },
      attributes: {
        hp: { value: 10, max: 10, temp: 0, pct: 100, bars: 5, hpPerBar: 2 },
        mana: { value: 0, max: 0, pct: 100 },
        evade: { items: 0, buffs: 0, total: 3 },
        dr: { armor: 2, items: 0, buffs: 0, total: 2 },
        speed: { move: 20, step: 10 },
        aiFavor: 0,
        size: "Large",
  ...
  // 10. Dread Wizard Grimblegore (Neighborhood Boss, Large 5, Humanoid)
  {
    ...
    system: {
      abilities: {
        ...
        cha: { value: 5, unenhanced: 5, mod: 2 }
      },
      attributes: {
        hp: { value: 60, max: 60, temp: 0, pct: 100, bars: 12, hpPerBar: 5 },
        mana: { value: 10, max: 10, pct: 100 },
        evade: { items: 0, buffs: 0, total: 4 },
        dr: { armor: 2, items: 0, buffs: 0, total: 2 },
        speed: { move: 20, step: 10 },
  ...
  // 11. Cocaine Kobold (Mob, Petite 3, Lizard)
  {
    ...
    system: {
      abilities: {
        str: { value: 3, unenhanced: 3, mod: 2 },
        int: { value: 6, unenhanced: 6, mod: 3 },
        con: { value: 6, unenhanced: 6, mod: 3 },
        dex: { value: 6, unenhanced: 6, mod: 3 },
        cha: { value: 2, unenhanced: 2, mod: 1 }
      },
      attributes: {
        hp: { value: 18, max: 18, temp: 0, pct: 100, bars: 6, hpPerBar: 3 },
        mana: { value: 0, max: 0, pct: 100 },
        evade: { items: 0, buffs: 0, total: 3 },
        dr: { armor: 2, items: 0, buffs: 0, total: 2 },
        speed: { move: 20, step: 10 },
  ...
  // 12. Danger Dingo (Mob, Medium 4, Beastly)
  {
    ...
    system: {
      abilities: {
        str: { value: 7, unenhanced: 7, mod: 3 },
        int: { value: 3, unenhanced: 3, mod: 2 },
        con: { value: 6, unenhanced: 6, mod: 3 },
        dex: { value: 2, unenhanced: 2, mod: 1 },
        cha: { value: 2, unenhanced: 2, mod: 1 }
      ...
      attributes: {
        hp: { value: 15, max: 15, temp: 0, pct: 100, bars: 5, hpPerBar: 3 },
        mana: { value: 0, max: 0, pct: 100 },
        evade: { items: 0, buffs: 0, total: 1 },
        dr: { armor: 2, items: 0, buffs: 0, total: 2 },
        speed: { move: 30, step: 10 },
  ...
  // 13. Jacked Kangaroo (Mob, Medium 4, Animal)
  {
    ...
    system: {
      ...
      attributes: {
        hp: { value: 32, max: 32, temp: 0, pct: 100, bars: 8, hpPerBar: 4 },
        mana: { value: 0, max: 0, pct: 100 },
        evade: { items: 0, buffs: 0, total: 2 },
        dr: { armor: 2, items: 0, buffs: 0, total: 2 },
  ...
  // 14. Jazmanian Devil (Mob, Petite 3, Humanoid)
  {
    ...
    system: {
      abilities: {
        str: { value: 6, unenhanced: 6, mod: 3 },
        int: { value: 2, unenhanced: 2, mod: 1 },
        con: { value: 6, unenhanced: 6, mod: 3 },
        dex: { value: 6, unenhanced: 6, mod: 3 },
        cha: { value: 6, unenhanced: 6, mod: 3 }
      },
      attributes: {
        hp: { value: 21, max: 21, temp: 0, pct: 100, bars: 7, hpPerBar: 3 },
        mana: { value: 0, max: 0, pct: 100 },
        evade: { items: 0, buffs: 0, total: 3 },
        dr: { armor: 2, items: 0, buffs: 0, total: 2 },
        speed: { move: 20, step: 10 },
  ...
  // 15. Whambat (Mob, Petite 3, Animal)
  {
    ...
    system: {
      ...
      attributes: {
        hp: { value: 6, max: 6, temp: 0, pct: 100, bars: 3, hpPerBar: 2 },
        mana: { value: 0, max: 0, pct: 100 },
        evade: { items: 0, buffs: 0, total: 3 },
        dr: { armor: 2, items: 0, buffs: 0, total: 2 },
        speed: { move: 20, step: 10 },
  ...
  // 16. Mick Moran (Neighborhood Boss, Large 5, Humanoid)
  {
  ...
  // 17. Brindle Grub (Mob, Small 2, Beastly)
  {
    ...
    system: {
      abilities: {
        str: { value: 1, unenhanced: 1, mod: 1 },
        int: { value: 1, unenhanced: 1, mod: 1 },
        con: { value: 7, unenhanced: 7, mod: 3 },
        dex: { value: 1, unenhanced: 1, mod: 1 },
        cha: { value: 1, unenhanced: 1, mod: 1 }
      },
      attributes: {
        hp: { value: 6, max: 6, temp: 0, pct: 100, bars: 2, hpPerBar: 3 },
        mana: { value: 0, max: 0, pct: 100 },
        evade: { items: 0, buffs: 0, total: 1 },
        dr: { armor: 2, items: 0, buffs: 0, total: 2 },
        speed: { move: 5, step: 5 },
  ...
  // 18. Cow-Tailed Brindle Grub (Mob, Petite 3, Beastly)
  {
    ...
    system: {
      abilities: {
        str: { value: 4, unenhanced: 4, mod: 2 },
        int: { value: 1, unenhanced: 1, mod: 1 },
        con: { value: 7, unenhanced: 7, mod: 3 },
        dex: { value: 1, unenhanced: 1, mod: 1 },
        cha: { value: 1, unenhanced: 1, mod: 1 }
      ...
      attributes: {
        hp: { value: 9, max: 9, temp: 0, pct: 100, bars: 3, hpPerBar: 3 },
        mana: { value: 0, max: 0, pct: 100 },
        evade: { items: 0, buffs: 0, total: 1 },
        dr: { armor: 2, items: 0, buffs: 0, total: 2 },
        speed: { move: 10, step: 5 },
  ...
  // 19. Brindled Vespa (Mob, Medium 4, Mutated)
  {
  ...
  // 20. Unvaccinated Clurichaun Rev-Up Consultant (Mob, Petite 3, Humanoid)
  {
    ...
    system: {
      abilities: {
        str: { value: 3, unenhanced: 3, mod: 2 },
        int: { value: 2, unenhanced: 2, mod: 1 },
        con: { value: 1, unenhanced: 1, mod: 1 },
        dex: { value: 6, unenhanced: 6, mod: 3 },
        cha: { value: 2, unenhanced: 2, mod: 1 }
      },
      attributes: {
        hp: { value: 3, max: 3, temp: 0, pct: 100, bars: 3, hpPerBar: 1 },
        mana: { value: 0, max: 0, pct: 100 },
        evade: { items: 0, buffs: 0, total: 3 },
        dr: { armor: 2, items: 0, buffs: 0, total: 2 },
        speed: { move: 25, step: 10 },
  ...
  // 21. Laminak Rev-Up Consultant Manager (Mob, Small 2, Humanoid)
  {
    ...
    system: {
      abilities: {
        ...
        int: { value: 6, unenhanced: 6, mod: 3 },
        con: { value: 3, unenhanced: 3, mod: 2 },
        dex: { value: 7, unenhanced: 7, mod: 3 },
        cha: { value: 6, unenhanced: 6, mod: 3 }
      },
      attributes: {
        hp: { value: 12, max: 12, temp: 0, pct: 100, bars: 6, hpPerBar: 2 },
        mana: { value: 6, max: 6, pct: 100 },
        evade: { items: 0, buffs: 0, total: 3 },
        dr: { armor: 2, items: 0, buffs: 0, total: 2 },
        speed: { move: 45, step: 10 },
        aiFavor: 0,
        size: "Small",
        debuffs: "",
        externalBuffs: { buff1: "", buff2: "", buff3: "" },
  ...
  // 22. Smombie (Mob, Medium 4, Undead)
  {
  ...
  // 23. Pack Rat (Mob, Tiny 1, Animal - Tutorial Mob)
  {
    ...
    system: {
      abilities: {
        ...
        int: { value: 2, unenhanced: 2, mod: 1 },
        con: { value: 3, unenhanced: 3, mod: 2 },
        dex: { value: 4, unenhanced: 4, mod: 2 },
        cha: { value: 1, unenhanced: 1, mod: 1 }
      },
      attributes: {
        hp: { value: 4, max: 4, temp: 0, pct: 100, bars: 2, hpPerBar: 2 },
        mana: { value: 0, max: 0, pct: 100 },
        evade: { items: 0, buffs: 0, total: 2 },
        dr: { armor: 1, items: 0, buffs: 0, total: 1 },
        speed: { move: 20, step: 10 },
